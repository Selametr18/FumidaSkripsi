...
public class ReportPelangganActivity extends AppCompatActivity {
    ...
    private void showDataWorkReport() {
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                String nominalBayar = jo.getString("alamat");
                ...
                dataListWorkReport.put("id_pelanggan", idClient);
                dataListWorkReport.put("nama", namaPelanggan);
                dataListWorkReport.put("alamat", nominalBayar);
                dataListWorkReport.put("pengerjaan", ketBayar);
